...
interface PdfCompressPreviewProps {
  fileInfo: PdfFileInfo;
  onRemove: () => void;
}

export function PdfCompressPreview({ fileInfo, onRemove }: PdfCompressPreviewProps) {
  return (
    <div className="flex items-center gap-4 p-4 bg-white border border-slate-200 rounded-2xl shadow-sm relative group hover:border-blue-300 transition-colors">
